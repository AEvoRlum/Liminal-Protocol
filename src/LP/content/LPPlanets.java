...
import mindustry.world.generator.ErekirPlanetGenerator;
import mindustry.world.generator.SerpuloPlanetGenerator;
...
public class LPPlanets {
    ...
    public static void load() {
        ...
        mx.meshLoader = () -> new MultiMesh(
            new SunMesh(mx, 5, 5, 0.3, 1.5, 1.2, 1, 1.1,
        ...
        mx1 = new Planet("mx1", mx, 0.62, 2);
        mx1.generator = new ErekirPlanetGenerator() {
            @Override
            public Seq<mindustry.type.Schematic> getDefaultLoadout() {
                return Seq.with();
            }
        };
        ...
        mx2 = new Planet("mx2", mx, 3, 1);
        mx2.generator = new SerpuloPlanetGenerator();
        mx2.cloudMeshLoader = () -> new MultiMesh(
            new HexSkyMesh(mx2, 33, -6, 0.02f, 7.7f, Color.valueOf("ADC9C2"), 9.7f, 0.5f, 0.88f, 0.42f),
            new HexSkyMesh(mx2, 44, 1.6f, 0.09f, 7.9f, Color.valueOf("B08A85"), 6.5f, 0.5f, 0.91f, 0.42f),
            new HexSkyMesh(mx2, 64, -1.2f, 0.13f, 7.8f, Color.valueOf("9B766E"), 7, 0.5f, 0.82f, 0.44f),
            new HexSkyMesh(mx2, 24, 2, 0.21f, 7.9f, Color.valueOf("267392"), 5, 0.42f, 0.42f, 0.42f),
            new HexSkyMesh(mx2, 72, -1, 0.06f, 7.8f, Color.valueOf("BDB8D7"), 9, 0.6f, 0.66f, 0.5f),
            new HexSkyMesh(mx2, 4, 4, 0.08f, 7.7f, Color.valueOf("AE968E"), 7.8f, 0.54f, 0.56f, 0.46f),
            new HexSkyMesh(mx2, 11, -1.9f, 0.05f, 7.6f, Color.valueOf("1380A9"), 6.6f, 0.79f, 0.48f, 0.48f),
            new HexSkyMesh(mx2, 87, -2.5f, 0.14f, 7.8f, Color.valueOf("B5D5CF"), 8.2f, 0.55f, 0.7f, 0.4f),
            new HexSkyMesh(mx2, 92, 3.2f, 0.08f, 7.9f, Color.valueOf("C49A95"), 7, 0.48f, 0.8f, 0.45f),
            new HexSkyMesh(mx2, 15, -0.8f, 0.17f, 7.5f, Color.valueOf("8A6A63"), 6.8f, 0.52f, 0.6f, 0.5f),
            new HexSkyMesh(mx2, 51, 5, 0.04f, 7.4f, Color.valueOf("2A839F"), 5.5f, 0.6f, 0.5f, 0.38f),
            new HexSkyMesh(mx2, 38, -3, 0.23f, 7.7f, Color.valueOf("A9A3C2"), 8.5f, 0.65f, 0.72f, 0.46f),
            new HexSkyMesh(mx2, 29, 1.2f, 0.12f, 7.9f, Color.valueOf("BCAAA3"), 7.2f, 0.5f, 0.6f, 0.43f),
            new HexSkyMesh(mx2, 63, -2.1f, 0.07f, 7.8f, Color.valueOf("1F6B8F"), 6, 0.7f, 0.5f, 0.41f),
            new HexSkyMesh(mx2, 79, 2.8f, 0.11f, 7.6f, Color.valueOf("D3D8DD"), 9.5f, 0.45f, 0.9f, 0.44f),
            new HexSkyMesh(mx2, 8, -4, 0.24f, 7.5f, Color.valueOf("5C5278"), 5.8f, 0.58f, 0.55f, 0.39f),
            new HexSkyMesh(mx2, 56, 1.9f, 0.05f, 7.7f, Color.valueOf("8FCCC4"), 8.8f, 0.5f, 0.78f, 0.42f)
        );
        ...
        mx3 = new Planet("mx3", mx, 1, 3.5f);
        mx3.generator = new SerpuloPlanetGenerator();
        mx3.cloudMeshLoader = () -> new MultiMesh(
            new HexSkyMesh(mx3, 77, -1.2f, 0.08f, 6.5f, Color.valueOf("88A1C980"), 5, 0.5f, 0.8f, 0.4f),
            new HexSkyMesh(mx3, 65, 0.5f, 0.13f, 6.6f, Color.valueOf("AABDD980"), 6, 0.6f, 0.85f, 0.45f),
            new HexSkyMesh(mx3, 24, 2.0f, 0.086f, 6.7f, Color.valueOf("BAC9DD80"), 7, 0.7f, 0.9f, 0.5f)
        );
